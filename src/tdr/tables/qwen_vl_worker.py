...
from src.tdr.tables.vision import leer_tabla_visual, leer_tabla_crosspage
from src.tdr.tables.validator import validar_tabla_markdown
from src.tdr.config.settings import TABLE_VL_MAX_BATCH, TABLE_VALIDATOR_MIN_SCORE
