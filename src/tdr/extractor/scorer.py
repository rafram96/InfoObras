...
from src.tdr.config.settings import SCORER_MIN_SCORE, SCORER_MAX_GAP, SCORER_CONTEXT
from src.tdr.config.signals import SIGNALS
from src.tdr.extractor.parser import PageResult
