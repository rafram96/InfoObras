"""
Extractor de TDR (bases de concurso) — punto de entrada CLI.

Uso:
    python run_tdr.py extraer "data/bases.pdf" --dry-run
    python run_tdr.py extraer "data/bases.pdf" --reuse-ocr
    python run_tdr.py extraer "data/bases.pdf"
"""
import argparse
import json
import logging
...
from src.tdr.clients.motor_ocr_client import invoke_motor_ocr, check_motor_ocr_available
...
from src.tdr.config.settings import OUTPUT_DIR
